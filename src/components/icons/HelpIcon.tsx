  ...
  return (
    ...
    >
      ...
      <rect
        ...
        fill-opacity="0"
      />
      <g clip-path="url(#clip0_3966)">
        <path
          id="Vector"
          d="M12 13.5C11.98 13.17 12.06 12.85 12.24 12.58C12.42 12.31 12.69 12.1 13 12C13.37 11.85 13.71 11.62 13.98 11.33C14.25 11.03 14.45 10.67 14.56 10.29C14.68 9.9 14.7 9.49 14.62 9.1C14.55 8.7 14.39 8.33 14.15 8.01C13.9 7.68 13.59 7.42 13.23 7.24C12.87 7.06 12.48 6.97 12.07 6.97C11.67 6.97 11.27 7.06 10.91 7.24C10.55 7.41 10.24 7.67 10 "
          stroke={fill}
        ...
        <path
          ...
          stroke-linecap="round"
        />
        <circle cx="12.2" cy="16.5" r="1" fill={fill} />
      </g>
    </svg>
  );
};
